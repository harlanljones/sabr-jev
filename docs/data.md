...
| Item | Value |
|---|---|
| Artifact | `priv/data/cards.json` (`schema_version: 1`, 32 cards, byte-identical rebuilds) |
...
| Recordings | 30 immutable (`priv/jev/recordings/`): 25 with retrospective oracle Noul, 4 qualified 2025 Choice/Score-only, Strider 2023 (2024 sample too small for oracle) |
...
`data/catalog.json` selects 32 real cards: sixteen of each role across 2021-2025.
